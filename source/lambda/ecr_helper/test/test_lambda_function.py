...
def test_lambda_function_02(ecr_client, ssm_client, env_variables_02):
    ...
    assert response['Payload'] == [{'repositoryName': 'ubuntu', 'imageTag': 'v2.2.0'},
                                   {'repositoryName': 'test-repository-01', 'imageTag': 'latest'}]
...
def test_lambda_function_04(ecr_client, ssm_client_02, env_variables_04):
    ...
    assert response['Payload'] == [{'repositoryName': 'ubuntu', 'imageTag': 'latest'},
                                   {'repositoryName': 'ubuntu', 'imageTag': 'v2.3.0'},
                                   {'repositoryName': 'ubuntu', 'imageTag': 'v2.2.0'},
                                   {'repositoryName': 'test-repository-01', 'imageTag': 'latest'}]
